...
featuring long-run risk, the third likelihood ratio can generate the state-dependent uncertainty
...
In asset pricing data, the effects of investors' \emph{risk aversion} and \emph{wrong beliefs} are
confounded.  In a rational expectations model with a
risk-averse representative investor, higher mean returns compensate for
higher risks.  But if the representative investor holds wrong beliefs, belying a rational expectations assumption,
...
$\tilde w_t$.  The ``and more'' in my subtitle refers to $\bar w_t$, a parametric
...
This paper has used likelihood ratios to organize three distinct explanations for observed risk prices---risk aversion, mistaken beliefs, and fears of model misspecification---and has shown how the third, properly formalized, can account for puzzling term-structure dynamics.
...
macroeconomics. Dave Backus spent a lot of time teaching us how to  improve connections  between theory and evidence. I wish he were still here. But  I  still hear him.
