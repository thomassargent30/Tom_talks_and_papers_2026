...
model misspecification.  I describe  likelihood ratios that:
...
forecasters, following Piazzesi, Salomao, and Schneider; and (iii)~capture fears of model misspecification, following Hansen and
Sz\H{o}ke.  I show how by using  a tilted discounted entropy
...
prices that can explain hitherto puzzling term-structure movements.
\end{abstract}
...
ratio processes $\{M_t = \prod_{s=0}^t m_t \}_{t=0}^\infty$ formed from (i)~risk prices $\lambda_t$,
...
Joint probability distributions of asset prices and macroeconomic fundamentals matter throughout macroeconomics.
