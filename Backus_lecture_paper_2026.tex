...
Long-standing puzzles about the term structure of interest rates that motivated some of Dave Backus's work motivate this paper too. I define a ``puzzle'' as a feature of the joint distribution of macroeconomic variables and asset returns implied by a ``standard'' benchmark macroeconomic model that is contradicted by U.S.\ time series data. In fact, the nominal yield curve usually slopes upward. The long-minus-short yield spread narrows before recessions and widens after them. Most strikingly, long-term bond yields are nearly as volatile as short-term yields even though, under the expectations theory of the term structure, they should be much smoother averages of expected future short rates.\footnote{For influential research about the expectations theory of the term structure of interest rates before rational expectations was imposed, see \citet{bierwag1967model} and \citet{meiselman1961term}.  For the rational expectations approach to the term structure, see \citet{hansen2019exact}.} This is Robert Shiller's (1979) ``volatility puzzle.''
