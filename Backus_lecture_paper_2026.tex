...
here.
His insistence on connecting theory tightly to data and his
generosity as a colleague and teacher at NYU Stern
animate every section of this paper.
...
The effects of \emph{risk aversion} and \emph{wrong beliefs} are
confounded in asset pricing data.  Under rational expectations with a
...
misunderstood return distributions.  Wrong beliefs contribute what from the point of view of an econometrician's baseline model 
look like ``stochastic discount factor shocks'' that have the  potential to 
explain observed countercyclical risk prices.

Long-standing puzzles about the term structure of interest rates
motivate this paper.  The nominal yield curve usually slopes upward,
the long-minus-short yield spread narrows before recessions and widens
...
is Shiller's ``volatility puzzle.''  To resolve it, risk prices---or
something observationally equivalent---must be large, volatile, and
state-dependent.  What generates those state-dependent risk prices?  It
could be risk aversion, it could be wrong beliefs, or it could be fears
of model misspecification.  Disentangling these sources is the central
...
The ``three martingales'' of the title are the cumulative likelihood
...
%% ====================================================================
\section{Rational Expectations and Its Limits}
\label{sec:RE-limits}
%% ====================================================================
...
cross-equation restrictions on decision makers' beliefs.  As Sz\H{o}ke
puts it:
\begin{quote}
