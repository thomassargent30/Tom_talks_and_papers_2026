...
\large Three Martingales and More}
...
misunderstood return distributions.  Wrong beliefs contribute what
look like ``stochastic discount factor shocks'' and can potentially
...
that twists one probability distribution into another.  Likelihood
...
Sz\H{o}ke (2017) & YES  & yes & yes \\[4pt]
\end{tabular}
\end{center}
